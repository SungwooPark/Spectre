...
class clock(Frame):
	...
	def getCoordinates(self, city, country):
		coordsURL = 'https://maps.googleapis.com/maps/api/geocode/json?address=' + city + "&components=country:" + country + '&key=' + googleAPPID
	...
	def getTimezoneDiff(self, city, country):
		lat, lon = self.getCoordinates(city, country) #tuple --> lat, lon
